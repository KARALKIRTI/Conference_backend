...
function startRazorpay(userData) {
    fetch('/api/create-order', {  // Updated the route to /api/create-order
        method: 'POST',
        headers: {
        ...
        if (data.success) {
            var options = {
                ...
                "handler": function (response) {
                    ...
                    fetch('/api/update-payment-status', {  // Updated the route to /api/update-payment-status
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json'
                        },
...
document.getElementById('loginForm').addEventListener('submit', function(event) {
    ...
    fetch('/api/login', {  // Updated the route to /api/login
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
    ...
    .then(data => {
        if (data.success) {
            ...
            fetch('/api/get-user-details')  // Updated the route to /api/get-user-details
                .then(response => {
                    if (!response.ok) {
                        throw new Error('Network response was not ok ' + response.statusText);
                    }
...
document.getElementById('signupForm').addEventListener('submit', function(event) {
    ...
    fetch('/api/signup', {  // Updated the route to /api/signup
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
